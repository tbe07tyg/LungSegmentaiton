...
def LungGen(inputSeries, labelSeries, input_mean_list_series , input_std_list_series, input_nonzeros_indexs_series,  batch_size, input_shape, anchors, num_classes, train_flag):
    ...
    while True:
        ...
        while b < batch_size:
            ...
            img, box, myPolygon, aug_mask, selected_coutours = my_get_random_data(selected_slice_input, selected_slice_mask,input_mean_list_series, input_std_list_series,
...
def my_get_random_data(input, mask, input_mean_list_series, input_std_list_series, full_name, image_datagen, mask_datagen, train_or_test):
    ...
    LB1, UB1 = -3000, 1700
    input1 =  np.clip(aug_image, LB1, UB1)
    input1 =  linear_norm(input1, LB1, UB1)
    print("input1 range: [{}, {}]".format(input1.min(), input1.max()))
    # win2  : window  [-1400 500]
    LB2, UB2 = -1400, 500
    input2 =np.clip(aug_image, LB2, UB2)
    input2 = linear_norm(input2, LB2, UB2)
